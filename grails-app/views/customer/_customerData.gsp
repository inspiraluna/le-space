<g:form>
  ...
  <table>
    ...
    <tr><th align="left"><g:message code="customer.country.label" />*:</th><td class="value ${hasErrors(bean: customer, field: 'country', 'errors')}"><g:select name="country.id"  from="${le.space.Country.list()}                                                                                                                                                               optionKey="id"  /></td></tr>
