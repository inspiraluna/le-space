                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="addressLine1" title="${message(code: 'customer.addressLine1.label', default: 'Address Line1')}" />
                        
                            <g:sortableColumn property="addressLine2" title="${message(code: 'customer.addressLine2.label', default: 'Address Line2')}" />
                    ...
                    <g:each in="${customerInstanceList}" status="i" var="customerInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: customerInstance, field: "addressLine1")}</td>
                        
                            <td>${fieldValue(bean: customerInstance, field: "addressLine2")}</td>
