            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="payment.paymentDate.label" default="Payment Date" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${paymentInstance?.paymentDate}" /></td>
