                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="paymentDate"><g:message code="payment.paymentDate.label" default="Payment Date" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: paymentInstance, field: 'paymentDate', 'errors')}">
                                    <g:datePicker name="paymentDate" value="${paymentInstance?.paymentDate}" ></g:datePicker>
                                </td>
                            </tr>
