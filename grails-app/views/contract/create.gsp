                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="toolService"><g:message code="contract.toolService.label" default="Tool Service" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: contractInstance, field: 'toolService', 'errors')}">
