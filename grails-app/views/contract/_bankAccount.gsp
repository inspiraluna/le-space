...
<tr><th colspan="2" align="left"><span class="button"><g:submitToRemote update="bankAccount" class="bankAccount" action="bankAccount" controller="customer" name="customerData" value="${g.message(code:'default.button.update.label')}" /></span></th></tr
</table>