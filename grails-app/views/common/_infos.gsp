<div id="infos">
  ...
  <p>Mo-Fr, 9-18 Uhr<br />
  Mit Schlüssel 24/7</p>
  <h2>Adresse</h2>
  <p>Le Space (beta)<br />
  Lützner Straße 91, 04177 Leipzig<br />
  Im <a href="http://www.tapetenwerk.de/" class="extern" target="_blank">Tapetenwerk</a>, Haus K<br />
  Tram 8, 15 Haltestelle Henriettenstraße</p>
  <h2>Kontakt</h2>
  <p>Telefon +49 (0)341 / 4 78 58 70<br />
  E-Mail: <a href="mailto:info@le-space.de" target="_blank">info@le-space.de</a><br />
  Twitter:<a href="http://twitter.com/le_space_beta" target="_blank">@le_space_beta</a><br />
  Skype-Chat: <a href="skype:?chat&blob=jZHLGil1O6yWUOPrvPinptMuE6To9wOXoqgbtU-qxbugKi_KZ2QpkD5dUeCjhiliSg" target="_blank"> click!</a>
</p>


  <div class="extern">
  <hr />
  <h2>Coworking Links</h2>
    <ul>
      <li><a href="http://de.wikipedia.org/wiki/Coworking" class="extern" target="_blank">Wikipedia Artikel</a></li>
      <li><a href="http://www.coworking-news.de/" class="extern" target="_blank">Coworking News aus München</a></li>
