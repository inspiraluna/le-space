<table><td valign="top" width="300">
    <h2>§ 1 Allgemeines</h2>
    <p>(1) Die nachfolgenden Allgemeinen Geschäftsbedingungen gelten für
      ...
      schriftliche Bestätigung durch Le Space keine Geltung.</p>
    <p>(2) Das Angebot richtet sich sowohl an Privatkunden, als auch an
    ...
    <p>(1) Gegenstand der Angebote und Dienstleistungen von Le Space ist die
      ...
      - Durchführung von Veranstaltungen</p>
    <p>(2) Je nach gewählter Vertragsart / Tarif ist die Nutzungsmöglichkeit auf
    ...
    <br/>6. Fixdesk Monat:  Nutzungsberechtigung eines bestimmten Arbeitsplatzes inklusive unbegrenzter Internetnutzung (W-Lan)im Rahmen der Öffnungszeiten.
    <br/>7. Briefkasten: Einrichtung eines Briefkastens. Postannahme.
    <br/>8. Schließfach: Bereitstellung eines abschließbaren Faches für Wertgegenstände.
    <br/>9. Schlüssel: Bereitstellung eines Schlüssels für die Nutzung der Räume außerhalb der Öffnungszeiten.
  </p><p>(3) Die Büroarbeitsplätze sind ausgestattet mit: Tisch, Stuhl, Strom, WLAN
</p><p>(4) Der Kunde hat die Ausstattung vor Beginn des Vertragsverhältnisses ausführlich überprüft und deren Funktionsfähigkeit anerkannt.
</p><p>(5) Die Arbeitsplätze dürfen durch den Kunden nur für den bezeichneten Betrieb und den angegebenen Zweck benutzt werden. Eine Änderung des
...
<h2>§ 3 Zugangsbedingungen und Verhaltensregeln</h2>
<p>Der Zugang zu Le Space ist für
  <br/>1. Kunden ohne Schlüssel nur während der allgemeinen Öffnungszeiten möglich.
  <br/>2. Nutzer mit dem persönlichen Zugangscode/Schlüssel stets möglich. Der Verlust des Schlüssels ist
...
<p>(1) Mit der Buchung durch den Kunden kommt ein Vertrag mit Le Space
  entsprechend dem vom Kunden gewählten Tarif zustande.
</p><p>(2) Der Vertragsschluss erfolgt schriftlich oder über das Online –
  ...
  anzuzeigen.
</p><p>(3) Ein Nutzervertrag zwischen dem Kunden und Le Space kommt erst
...
<h2>§ 6 Tarife und Zahlungsmodalitäten, Kaution</h2>
<p>(1) Alle Preise von Le Space sind Bruttopreise einschließlich der jeweils
...
</p><p>(2) Der Kunde ermächtigt Le Space zur Einziehung des vereinbarten
...
</p><p>(3) Bankgebühren und Bearbeitungskosten, die Le Space infolge der
  Nichteinlösung der Lastschrift oder aufgrund eines Widerspruchs
  entstehen, gehen zu Lasten des Kunden.
</p><p>(4) Die Zahlung ist unmittelbar mit dem Vertragsschluss fällig. Soweit die
...
</p><p>(5) Der Kunde der Tarife zu § 2 Absatz 2 Ziffer 3, 4, 5 und 6 zahlt an Le
...
<h2>§ 7 Datenschutz</h2>
<p>(1) Le Space wird die Vorschriften über den Datenschutz nach dem
  Bundesdatenschutzgesetz (BDSG) und den weiteren gesetzlichen
  Vorschriften zum Datenschutz beachten.
</p><p>(2) Der Kunde erklärt sein Einverständnis damit, dass seine für die
...
</p><p>(3) Dem Kunden steht das Recht zu, seine Einwilligung jederzeit mit
  Wirkung für die Zukunft zu widerrufen. Le Space verpflichtet sich in diesem
  Fall zur sofortigen Löschung der persönlichen Daten des Kunden.</pre>
</p></td>
<td width="300"><h2>§ 8 Kündigungen</h2>
  <p>(1) Beide Parteien können das Vertragsverhältnis zur vertraglich
  ...
  </p><p>(2) Le Space kann das Vertragsverhältnis ohne Einhaltung einer
  ...
  </p><p>(3) Der Kunde kann das Vertragsverhältnis ohne Einhaltung einer
  ...
  <h2>§ 9 Vertragsdurchführung</h2>
  <p>(1) Der Kunde ist im Rahmen der FIXdesk Tarife berechtigt, eigene
  ...
  </p><p>(2) Der Kunde ist verpflichtet, Le Space seinen Arbeitsplatz in
    ...
    Kunden und Le Space.
  </p><p>(3) Die Untervermietung an Dritte ist ausgeschlossen.
  </p><p>(4) (Technische) Veränderungen an den Arbeitsplätzen, die nicht in die
  ...
  </p><p>(5) Le Space darf Ausbesserungen, Instandsetzungen und bauliche
  ...
  <p>(1) Der Kunde hat die Arbeitsplätze vor Vertragsschluss eingehend
  ...
  </p><p>(2) Dem Kunden ist bekannt, dass im Hause in absehbarer Zeit
  ...
  </p><p>(3) In allen Fällen, in denen Le Space im geschäftlichen Verkehr aufgrund
  ...
  </p><p>(4) Le Space übernimmt keine Haftung für die Verletzung von
  ...
  <p>(1) Der Kunde hat die Gegenstände pfleglich zu behandeln und nach
  ...
  </p><p>(2) Der Kunde hat sämtliche, auch die von ihm selbst beschafften
  ...
  </p><p>(3) Gibt der Kunde den Arbeitsplatz nicht rechtzeitig heraus, haftet er Le
  ...
  <p>Le Space behält sich vor, diese AGB jederzeit zu ändern. Die Änderung
  ...
  <p>(1) Allgemeine Geschäftsbedingungen des Kunden finden keine
    Anwendung, auch wenn der Einbeziehung nicht ausdrücklich
    widersprochen wurde.
  </p><p>(2) Es gilt das Recht der Bundesrepublik Deutschland.
  </p><p>(3) Der Gerichtsstand ist der Sitz von Le Space in Leipzig.
  </p><p>(4) Sollten einzelne Bestimmungen ganz oder teilweise unwirksam
